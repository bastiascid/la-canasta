...
try {
    ...
    // 5. Always empty and re-seed products to ensure clean official catalog with client images
    $pdo->exec("TRUNCATE TABLE products");
    
    $products = [
        // Iansa (Brand ID 2)
        ['Azúcar Granulada Iansa (Saco 25kg)', $brand_ids['Iansa'], 'assets/up_6a248ea6935b7.jpg', 'Saco industrial de azúcar granulada blanca, indispensable en panaderías y almacenes.', 'Abarrotes', 1, 1],
