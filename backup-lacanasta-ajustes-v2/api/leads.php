...
if ($method === 'POST') {
    ...
    try {
        ...
        // 1. Email to Admin
        $admin_email = 'contacto@lacanastadistribuidora.cl';
        $admin_subject = "=?UTF-8?B?" . base64_encode("[Nuevo Lead] La Canasta Distribuidora - $origin") . "?=";
        $admin_headers = "MIME-Version: 1.0\r\n";
        $admin_headers .= "Content-Type: text/html; charset=UTF-8\r\n";
        $admin_headers .= "From: La Canasta Web <no-reply@lacanastadistribuidora.cl>\r\n";
        ...
        <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
            <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;'>
                ...
                <p style='margin-top: 25px; font-size: 0.85em; color: #777; border-top: 1px dashed #ddd; padding-top: 10px;'>Este mensaje fue enviado de manera automática desde el servidor de La Canasta Distribuidora.</p>
            </div>
        </body>
        </html>
        ";
        ...
        $user_subject = "=?UTF-8?B?" . base64_encode("Recibimos tu solicitud - La Canasta Distribuidora") . "?=";
        $user_headers = "MIME-Version: 1.0\r\n";
        $user_headers .= "Content-Type: text/html; charset=UTF-8\r\n";
        $user_headers .= "From: La Canasta Distribuidora <contacto@lacanastadistribuidora.cl>\r\n";
        ...
        <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
            <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;'>
                <h2 style='color: #5d4637; border-bottom: 2px solid #b83b1d; padding-bottom: 10px;'>La Canasta Distribuidora</h2>
                <p>Hola <strong>" . htmlspecialchars($name) . "</strong>,</p>
                <p>Gracias por contactarnos. Un ejecutivo de La Canasta Distribuidora se pondrá en contacto con usted a la brevedad.</p>
                ...
                <p style='margin-top: 25px;'>Saludos cordiales,<br><strong>Equipo Comercial</strong><br>La Canasta Distribuidora</p>
            </div>
        </body>
        </html>
        ";
        ...
        echo json_encode([
            'status' => 'success',
            'message' => 'Gracias por contactarnos. Un ejecutivo de La Canasta Distribuidora se pondrá en contacto con usted a la brevedad.'
        ]);
    } catch (Exception $e) {
        http_response_code(500);
        echo json_encode([
