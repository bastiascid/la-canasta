            ...
            <div id="contacto-seccion">
                <div class="client-form-card">
                    ...
                    <form id="hazteClienteForm" class="contact-form" style="display: flex; flex-direction: column; gap: 1rem;">
                        ...
                        <div class="form-group">
                            <label style="font-weight: 700; font-size: 0.85rem; color: var(--color-text-dark);">RUT *</label>
                            <input type="text" name="rut" required placeholder="Ej: 12.345.678-9" style="padding: 0.75rem; border-radius: var(--border-radius); border: 1px solid var(--color-border); font-size: 0.9rem;">
                        </div>
                        ...
                        <div class="form-group">
                            <label style="font-weight: 700; font-size: 0.85rem; color: var(--color-text-dark);">Región *</label>
                            <select name="region" required style="padding: 0.75rem; border-radius: var(--border-radius); border: 1px solid var(--color-border); font-size: 0.9rem; background: white;">
                                <option value="Región de O'Higgins" selected>Región de O'Higgins</option>
                            </select>
                        </div>
